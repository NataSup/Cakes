 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".mainslider-conditers__slider")) {
                new core(".mainslider-conditers__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".rightslider-conditers__slider")) {
                new core(".rightslider-conditers__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 2,
            ...
            slider1.on("slideChange", (() => swipeAllSliders(slide1.activeIndex)));
            slider2.on("slideChange", (() => swipeAllSliders(slide2.activeIndex)));
        }
